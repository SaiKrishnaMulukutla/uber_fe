...
import { Button, MailIcon, PhoneIcon, CarIcon, ChevronRightIcon } from '@uber_fe/ui';
  ...
  return (
    <div className="px-4 py-4 pb-24 flex flex-col gap-4 animate-pulse">
      ...
      <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
        {[0, 1, 2].map((i) => (
          <div key={i} className={`flex items-center gap-3 px-5 py-4 ${i < 2 ? 'border-b border-gray-50' : ''}`}>
