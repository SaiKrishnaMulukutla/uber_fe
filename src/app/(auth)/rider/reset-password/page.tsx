...
import { riderResetPassword } from '@/lib/api'
...
function ResetForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true)
    try {
      await riderResetPassword(email, otp, password)
  ...
  return (
    <div className="w-full max-w-sm">
      ...
      <div className="mt-5 text-center text-sm">
        <Link href="/rider/forgot-password" className="text-zinc-500 hover:text-zinc-300">
          Resend OTP
        </Link>
      </div>
    </div>
